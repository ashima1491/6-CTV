            ...
            <div class="row" >
                <div id="stepper" class="col-lg-12" style="background-color: ;">
                    ...
                    <div id="steptwo" style="display:none;">
                        ...
                        <br>
                        <input type="checkbox" name="model_selection" id="Ref_dose" disabled="disabled" value="Ref_dose1">&nbsp;&nbsp; CTV Reference Dose (RfD) <small></small>
                        <br>
                        <input type="checkbox" name="model_selection" id="NOEL" disabled="disabled" value="Ref_dose_NOEL1">&nbsp;&nbsp; CTV Reference Dose (RfD) NO(A)EL <small></small>

                        <BR>
                        <input type="checkbox" name="model_selection" id="ONBD" disabled="disabled" value="ONBD1">&nbsp;&nbsp; CTV Reference Dose (RfD) BMD <small></small>
                        <BR>
                        <input type="checkbox" name="model_selection" id="ONBDL" disabled="disabled" value="ONBD1">&nbsp;&nbsp; CTV Reference Dose (RfD) BMDL <small></small>
                        <BR>
                        
                        
                        <input type="checkbox" name="model_selection" id="Ref_conc" disabled="disabled" value="Ref_conc1">&nbsp;&nbsp; CTV Reference Concentration (RfC) <small></small>
                        <BR>
                        
                        <input type="checkbox" name="model_selection" id="Oral_slope" disabled="disabled" value="Oral_slope1">&nbsp;&nbsp; CTV Oral Slope Factor (OSF) <small></small>
                        <BR>
                        <input type="checkbox" name="model_selection" id="Canc_pot" disabled="disabled" value="Canc_pot1">&nbsp;&nbsp; CTV Cancer Potency Value (CPV) <small></small>
                        <br>
                        <input type="checkbox" name="model_selection" id="Ihal_unit" disabled="disabled" value="Ihal_unit1">&nbsp;&nbsp; CTV Inhalation Unit Risk (IUR) <small></small>
